    ...
    class Program {
        ...
        static void Main(string[] args) {
            while(true) {
                ...
                Console.WriteLine();
                if (Action == ConsoleKey.D1 || Action == ConsoleKey.NumPad1) AddFigure();
                ...
                else if (Action == ConsoleKey.D5 || Action == ConsoleKey.NumPad5) View();
                else if (Action == ConsoleKey.D6 || Action == ConsoleKey.NumPad6) Environment.Exit(0);
            }
